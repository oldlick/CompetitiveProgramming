...
int main(){
    ...
    V<ll> a(n);
    input(a);
    rep(i,a.size())a[i]+=i+1;
    V<ll> ans(m,0);
    priority_queue<V<ll>> q;
    rep(i,n){
        ll cnt=0,idx=0,add=i+1;
        if(a[i]>=0){
            cnt=a[i];
            idx=0;
        }else{
    ...
    while(q.size()){
        ...
        ll add=now[2];
        q.pop();
        if(ans[idx]==cnt)ans[idx]++;
        if(cnt+add>=n)continue;
        if(idx+1>=m)continue;
        debug((cnt+add),idx+1,add);
        q.push({-(cnt+add),idx+1,add});
    }
    print(ans);
    return 0;
}
...
4 4
0 -1 -6 -7
[135:]  cnt,idx,add     1 0 1
[135:]  cnt,idx,add     1 0 2
[135:]  cnt,idx,add     0 1 3
[135:]  cnt,idx,add     1 1 4
[142:]  now     [0 1 3]
[142:]  now     [-1 1 4]
[142:]  now     [-1 0 2]
[142:]  now     [-1 0 1]
...
3
-1 0 0 0 0 -5
[136:]  -cnt,idx,add    0 0 1
[136:]  -cnt,idx,add    0 -1 2
[136:]  -cnt,idx,add    0 -1 3
[136:]  -cnt,idx,add    0 -1 4
[136:]  -cnt,idx,add    0 -1 5
[136:]  -cnt,idx,add    -1 0 6
[143:]  now     [0 0 1]
[143:]  now     [-1 1 1]
[143:]  now     [-1 0 6]
2 0 0 
...
-1 1 2 3 4 5
[136:]  -cnt,idx,add    0 0 1
[136:]  -cnt,idx,add    -1 0 2
[136:]  -cnt,idx,add    -2 0 3
[136:]  -cnt,idx,add    -3 0 4
[136:]  -cnt,idx,add    -4 0 5
[136:]  -cnt,idx,add    -5 0 6
[143:]  now     [0 0 1]
[143:]  now     [-1 1 1]
[143:]  now     [-1 0 2]
[143:]  now     [-2 0 3]
